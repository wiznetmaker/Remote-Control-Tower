...
//
//#define IR_RECEIVE_PIN      14  // GPIO15 to be compatible with the Arduino Nano RP2040 Connect (pin3)
//#define IR_SEND_PIN         11  // GPIO16
//
//#undef  LED_BUILTIN
...
#define IR_RECEIVE_PIN      14  // GPIO15 to be compatible with the Arduino Nano RP2040 Connect (pin3)
#define IR_SEND_PIN         27  // GPIO16
#define TONE_PIN            26
#define APPLICATION_PIN     26
#define ALTERNATIVE_IR_FEEDBACK_LED_PIN 22 // E.g. used for examples which use LED_BUILDIN for example output.
#define _IR_TIMING_TEST_PIN 0
